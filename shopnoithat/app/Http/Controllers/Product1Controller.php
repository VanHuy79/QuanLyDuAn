...
class Product1Controller extends Controller
{
    ...
    public function index()
    {
        ...
        $pro1=product_models::where('categorie_id','10')->get();
        $pro2=product_models::where('categorie_id','11')->get();
        $pro3=product_models::where('categorie_id','12')->get();
        $pro4=product_models::where('categorie_id','13')->get();
        $pro5=product_models::where('categorie_id','14')->get();
